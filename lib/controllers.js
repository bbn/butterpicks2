(function() {
  var Game, Period, User, UserPeriod, couch, journey, models, request, util, _;
  ...
  exports.router.map(function() {
    ...
    return this.get("/user-period").bind(function(req, res, params) {
      var f;
      if (!(params.userId || params.periodId)) {
        return res.send(400, {}, {
          error: "need either or both userId and periodId param"
        });
      }
      if (params.userId && params.periodId) {
