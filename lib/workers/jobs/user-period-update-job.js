(function() {
  ...
  module.exports = UserPeriodUpdateJob = (function(_super) {
          ...
          return _this.period.fetch({
            ...
            success: function(model, response) {
              return _this.updatePoints({
                error: options.error,
                success: function() {
                  return _this.updateAchievements({
                    error: options.error,
                    success: function() {
                      return options.success(_this);
                    }
        ...
        success: function(games) {
          ...
          return _this.userPeriod.fetchPicks({
            ...
            success: function(picks) {
              ...
              if (points === _this.userPeriod.get("points")) {
                return options.success(_this);
              }
    ...
    UserPeriodUpdateJob.prototype.updateAchievements = function(options) {
